...
import { TransactionFormSkeleton } from "../skeletons";

const TransactionPage = () => {
  const { id } = useParams();
  const { data, loading } = useQuery<TransactionData>(GET_TRANSACTION, {
    variables: {
      id,
    },
  });
    ...
    <div className="h-screen max-w-4xl mx-auto flex flex-col items-center">
      ...
      >
        ...
        <button
          ...
          type="submit"
          disabled={updatingTransactionLoader}
        >
          {updatingTransactionLoader ? "Updating..." : "Update Transaction"}
        </button>
      </form>
    </div>
  );
